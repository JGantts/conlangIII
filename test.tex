...
[ SENTENCE \\ 1
    ...
    [ 2 \\ 3
        [ HEAD
	        [ \color{accent}AUX [\leafnode{dç}{HAB(s)} ] ]
        ]
        [ COMP \\ 3
            [ HEAD
              	[ \color{accent}VBLZ [\leafnode{ar}{V.IPFV} ] ]
...
[
    HEAD \\ 1
    [ SPEC \\ HEAD [ \color{accent}VBLZ [\leafnode{ar}{V.IPFV}] ] ]
    [ 2 \\ HEAD [ \color{accent}VERB [\leafnode{aqueçv}{whisper}] ] ]
]
\end{forest}
\begin{forest}
  for tree={
...
[
    HEAD \\ 1
    [ HEAD \\HEAD [ \color{accent}VBLZ [\leafnode{ar}{V.IPFV}] ] ]
    [ COMP \\ HEAD [ \color{accent}VERB [\leafnode{aqueçv}{whisper}] ] ]
]
\end{forest}
\end{exe}
